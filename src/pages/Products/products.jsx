...
function Products() {
  ...
  // State kullanarak hangi rectangle'ın gösterileceğini takip et
  ...
  // Rectangle'ları tutan bir dizi oluşturun
  const rectangles = [
    ...
    // Daha fazla rectangle ekleyebilirsiniz
  ];

  // İleri veya geri gitme işlevlerini tanımlayın
  const goToNext = () => {
...
return (
  <div className="container">
    {/* Sadece üç rectangle'ı göstermek için bir dizi döngüsü */}
